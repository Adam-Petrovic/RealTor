    ...
    public void onClick(View v)
    {
        if (v == nextButton)
        {
            Retrofit retrofit = new Retrofit.Builder()
                    .baseUrl("https://f5af-138-51-65-233.ngrok-free.app/")
            ...
            EditText bathrooms = (EditText) findViewById(R.id.num_washrooms);
            EditText sqft = (EditText) findViewById(R.id.land_area);
            EditText mean_district_income = (EditText) findViewById(R.id.mean_district_income);
            EditText bedrooms_ag = (EditText) findViewById(R.id.num_bedrooms_ag);
            EditText bedrooms_bg = (EditText) findViewById(R.id.num_bedrooms_bg);

            userData.list_price = Double.parseDouble(String.valueOf(price.getText()));
            userData.bathrooms = Integer.parseInt(String.valueOf(bathrooms.getText()));
            userData.sqft = Double.parseDouble(String.valueOf(sqft.getText()));
            userData.lat = latLng.latitude;
            userData.lon = latLng.longitude;
            userData.mean_district_income = Double.parseDouble(String.valueOf(mean_district_income.getText()));
            userData.bedrooms_ag = Integer.parseInt(String.valueOf(bedrooms_ag.getText()));
            userData.bedrooms_bg = Integer.parseInt(String.valueOf(bedrooms_bg.getText()));
...
//            userData.list_price = 999999999;
//            userData.bathrooms = 2;
            ...
            call.enqueue(new Callback<Price>() {
                ...
                public void onResponse(Call<Price> call, Response<Price> response) {
                    if (response.isSuccessful()) {
                        ...
                        Log.v("Price", returnedPrice + " : " + id);
                        nextButton.setText(returnedPrice.toString());
